...
|---|--------|----------|--------|-------|
| 01 | [Marché Immobilier DVF — Pyrénées-Atlantiques](./01-marche-immobilier-dvf/) | Projet académique | Power BI, Power Query, DAX, INSEE | 2025 |
| 02 | [Analyse Commerciale — Mikaté Bon Goût](./02-mikate-bon-gout/) | Stage commercial | Excel (VBA), Power BI, DAX | 2025 |
| 03 | [Gestion des Stocks — Hôtel Albertine Rock](./03-albertine-rock-hotel/) | Stage logistique | Excel, Power BI, SQL | 2024 |
...
- **ETL & Power Query** — Nettoyage, jointures multi-sources, transformation
- **DAX** — Mesures calculées, CALCULATE, MEDIANX, RANKX, VAR/RETURN
- **Modélisation** — Schéma en étoile, relations, tables de dimensions
...
> 💡 *Données simulées et anonymisées pour les projets de stage — 
